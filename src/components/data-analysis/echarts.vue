  ...
  <div class="analysisCardStyle">
    ...
    <div id="echartsCard" v-loading="loading">
      ...
      <div v-show="picFilterFlag" style="margin-left:16px">&nbsp;
        ...
        <!-- 字段筛选器部分 -->
        <el-dropdown trigger="click" class="dropdowmMenuStyle" v-for="(val,index) in dropdownArray_text" :key="index"
        ...
        <!-- 数值筛选器部分 -->
        <el-dropdown trigger="click" class="dropdowmMenuStyle" v-for="val in dropdownArray_number" :key="val"
